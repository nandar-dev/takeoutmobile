...
class _RefillWalletPageState extends State<RefillWalletPage> {
  ...
  final List<String> paymethodMethodOptions = ["K Pay", "CB Pay", "AYA Pay"];
  PlatformFile? uploadedScreenshot;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomDropdownFormField<String>(
                            ...
                            validator: (val) => val == null ? paymentPlaceholder : null,
                          ),
